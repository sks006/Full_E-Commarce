...
export function Dashboard() {
  ...
  }, [dispatch, products.status, orders.status, customers.status, payments.status]);
        ...
        <Card className="p-4">
          ...
          <div className="space-y-4">
            {orders.items.slice(0, 5).map((order) => (
              <div key={order.id} className="flex items-center justify-between p-2 rounded-lg bg-accent/50">
